...
locals {
  ...
  awp_skip_function_app_scan       = local.scan_mode == SCAN_MODE_SAAS ? true : (var.awp_account_settings_azure != null ? (var.awp_account_settings_azure.skip_function_apps_scan != null ? var.awp_account_settings_azure.skip_function_apps_scan : false) : false)  
